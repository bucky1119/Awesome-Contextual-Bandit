        ...
        if name == 'neural_bandit':
            ...
            class HParams:
                def __init__(self, num_actions):
                    ...
                    self.alpha = 1.0
            algorithms.append(UCB1Sampling("ucb1", HParams(num_actions)))
            ...
            algorithms.append(LinUCBSampling("linucb", HParams(context_dim, num_actions)))
            ...
            algorithms.append(EpsilonGreedySampling("epsilon_greedy", HParams(num_actions)))
            ...
            algorithms.append(NeuralUCBSampling(hparams, name="neural_ucb"))
            ...
            algorithms.append(NeuralLinUCBSampling(hparams, name="neural_linucb"))

        else:
            raise ValueError(f"Unknown algorithm: {name}. Supported: neural_bandit, neural_linear, ucb1, linucb, epsilon_greedy, neural_ucb, neural_linucb")
...
def main():
    ...
    parser.add_argument('--algorithms', nargs='+', default=['neural_bandit', 'neural_linear'],
                       choices=['neural_bandit', 'neural_linear', 'ucb1', 'linucb', 'epsilon_greedy', 'neural_ucb', 'neural_linucb'],
